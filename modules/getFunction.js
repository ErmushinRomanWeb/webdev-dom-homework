...
export function getFunction(commentators, loader) {
  ...
  getComments().then((responseData) => {//getComments(api.js) вызвали ее и она нам вернула промис с объектом в котором сохраненные данные с комментариями с сервера в формате json
